...
namespace TestApp
{
    public partial class BlobDirToLocalDir : Form
    {
        public BlobDirToLocalDir()
        {
            InitializeComponent();
        }
        ...
        private void BlobDirToLocalDir_Load(object sender, EventArgs e)
        {
        ...
        private async void btnOK_Click_1(object sender, EventArgs e)
        {
            ...
            await mng.DownloadAzureBlobDirectoryToLocalDirectory(txtFB.Text, cmbBlobContainers.SelectedItem.ToString(), chkRecursive.Checked);
            this.Close();
        }
    }
}
